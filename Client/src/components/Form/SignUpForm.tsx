    ...
    return (
        <div>
            <Form onSubmit={handleSubmit(onSubmit)}>
                <InputBox type="text" id="firstName" placeholder="שם פרטי" name="First name"
                          ref={register({required: true, maxLength: 80})} />
                <br/>
                <InputBox type="text" id="lastName" placeholder="שם משפחה" name="Last name"
                          ref={register({required: true, maxLength: 100})} />
                <br/>
                <InputBox type="text" id="email" placeholder="אימייל" name="Email"
                          ref={register({required: true, pattern: /^\S+@\S+$/i})} />
                <br/>
                <InputBox type="tel" id="phone" placeholder="טלפון נייד" name="Mobile number"
                          ref={register({required: true, minLength: 6, maxLength: 12})} />
                <br/>
                <InputBox type="text" id="password" placeholder="סיסמא" name="סיסמא"
